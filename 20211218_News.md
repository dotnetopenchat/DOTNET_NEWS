...
3) 창피한 제품명 생성: Windows CE
    - URL : https://devblogs.microsoft.com/oldnewthing/20211214-00/?p=106030

4) .NET 2021년 12월 업데이트 – 6.0.1, 5.0.13 및 3.1.22
    - URL : https://devblogs.microsoft.com/dotnet/december-2021-updates/

5) Visual Studio Code C++ 2021년 12월 업데이트: clang-tidy
    - URL : https://devblogs.microsoft.com/cppblog/visual-studio-code-c-december-2021-update-clang-tidy/

6) 기본 명령줄 환경으로 Windows 터미널
    - URL : https://devblogs.microsoft.com/commandline/windows-terminal-as-your-default-command-line-experience/

7) Azure DevOps(및 Azure DevOps Server) 및 log4j 취약점
    - URL : https://devblogs.microsoft.com/devops/azure-devops-and-azure-devops-server-and-the-log4j-vulnerability/

8) "실행하지 말고 실행될 때 내 코드를 디버그하십시오"는 무엇을 의미합니까?
    - URL : https://devblogs.microsoft.com/oldnewthing/20211215-00/?p=106033

9) Azure DevOps Server용 12월 패치
    - URL : https://devblogs.microsoft.com/devops/december-patches-for-azure-devops-server/

10) Visual Studio 2022를 사용한 .NET 생산성의 새로
    - URL : https://devblogs.microsoft.com/visualstudio/whats-new-in-net-productivity-with-visual-studio-2022/

11) EF7 계획 발표
    - URL : https://devblogs.microsoft.com/dotnet/announcing-the-plan-for-ef7/

12) Mac용 Visual Studio 2022 미리 보기 4
    - URL : https://devblogs.microsoft.com/visualstudio/visual-studio-2022-for-mac-preview-4/

13) 스택 오버플로 예외가 발생하는 정확한 지점이 실행할 때마다 변경되는 이유는 무엇입니까?
    - URL : https://devblogs.microsoft.com/oldnewthing/20211216-00/?p=106038

14) Visual Studio의 피드백을 업그레이드 중입니다! 
    - URL : https://devblogs.microsoft.com/visualstudio/were-upgrading-visual-studios-feedback/

10) Microsoft DevOps 커뮤니티의 주요 기사 – 2021.12.17
    - URL : https://devblogs.microsoft.com/devops/top-stories-from-the-microsoft-devops-community-2021-12-17/
