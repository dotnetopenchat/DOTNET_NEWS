## 주간뉴스
1) 스택이 오버플로되기 전에 스택 오버플로 예외가 발생하는 이유는 무엇입니까?
    - URL : https://devblogs.microsoft.com/oldnewthing/20211217-00/?p=106040

2) Windows wednesday
    - URL : https://devblogs.microsoft.com/commandline/windows-wednesday/

3) .NET 및 플랫폼 간 앱용 테스트 도구
    - URL : https://devblogs.microsoft.com/visualstudio/vs22-test-tools-for-net-and-cross-platform-apps/

4) 비공식 Windows 10 및 11 오디오 워크스테이션 빌드 및 조정 가이드 – 3부
    - URL : https://devblogs.microsoft.com/windows-music-dev/unofficial-windows-10-and-11-audio-workstation-build-and-tweak-guide-part-3/

5) Visual Studio 대시보드
    - URL : https://devblogs.microsoft.com/visualstudio/your-visual-studio-dashboard/

6) 다중 모니터 시스템에서 프로그래밍 방식으로 모니터를 재배치하려면 어떻게 합니까?
    - URL : https://devblogs.microsoft.com/oldnewthing/20211222-00/?p=106048

7) GPU로 데이터를 가져오는 것은 쉽지만 꺼내는 것은 더 어렵습니다.
    - URL : https://devblogs.microsoft.com/oldnewthing/20211223-00/?p=106050
