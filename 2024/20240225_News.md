...
1. Mermaid를 사용하여 의미 론적 커널 및 Azure Openai 계획을 시각화하는 방법
   * URL : https://devblogs.microsoft.com/premier-developer/how-to-visualize-semantic-kernel-azure-openai-plans-using-mermaid/
2. Azure DevOps 파이프 라인 : 이상적인 서비스 연결 전략 발견
   * URL : https://devblogs.microsoft.com/premier-developer/azure-devops-pipelines-discovering-the-ideal-service-connection-strategy/
3. Visual Studio의 C ++ 게임 개발 개선 1 년
   * URL : https://devblogs.microsoft.com/visualstudio/a-year-of-c-game-development-improvements-in-visual-studio/
4. 작업 부하 신원이있는 AK에 Azure OpenAI 리소스를 소비합니다
   * URL : https://devblogs.microsoft.com/ise/consuming-azure-openai-resources-in-aks-with-workload-identities/