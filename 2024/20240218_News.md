...
1. 마지막 기회 : Visual Studio Live!- 라스베가스
   * URL : https://devblogs.microsoft.com/visualstudio/last-chance-visual-studio-live-las-vegas/
2. Azure 파이프 라인은 감가 상각 된 작업 퇴직 일정입니다
   * URL : https://devblogs.microsoft.com/devops/azure-pipelines-deprecated-tasks-retirement-schedule/
3. 아무것도하지 말고 적어도 올바르게 아무것도하지 않겠다면
   * URL : https://devblogs.microsoft.com/oldnewthing/20240216-00/?p=109409
4. 최종 알림 : Outlook REST API v2.0 및 베타 엔드 포인트 해체
   * URL : https://devblogs.microsoft.com/microsoft365dev/final-reminder-outlook-rest-api-v2-0-and-beta-endpoints-decommissioning/